...
void StudentuPadalinimas_Vector(const vector<Studentas>& studentai, bool pagalVidurki)
{
    if (studentai.empty()) {
    ...
    string vargsiukuFailas = "vargsiuku_" + tipas + "_vector.txt";
    ...
    string saunuoliuFailas = "saunuoliu_" + tipas + "_vector.txt";
...
void isvestiRezultatusIFaila_Vector(const string& failoPavadinimas, const vector<Studentas>& studentai, bool pagalVidurki, bool rodytiAbu)
{
...
void StudentuPadalinimas_List(const list<Studentas>& studentai, bool pagalVidurki)
{
    if (studentai.empty()) {
        cout << "Nera studentu duomenu padalijimui!" << endl;
        return;
    ...
    string vargsiukuFailas = "vargsiuku_" + tipas + "_list.txt";
    ofstream fout1(vargsiukuFailas);
    if (fout1.is_open()) {
        fout1 << left << setw(20) << "Vardas"
              << setw(20) << "Pavarde"
    ...
    string saunuoliuFailas = "saunuoliu_" + tipas + "_list.txt";
    ofstream fout2(saunuoliuFailas);
    if (fout2.is_open()) {
        fout2 << left << setw(20) << "Vardas"
              << setw(20) << "Pavarde"
...
void isvestiRezultatusIFaila_List(const string& failoPavadinimas, const list<Studentas>& studentai, bool pagalVidurki, bool rodytiAbu)
{
    ofstream fout(failoPavadinimas);
    if (!fout.is_open()) {
        cout << "Klaida: nepavyko sukurti failo " << failoPavadinimas << endl;
